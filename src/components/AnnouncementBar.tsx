...
export default function AnnouncementBar({ announcements }: { announcements: Announcement[] }) {
  ...
  return (
    <div className="relative z-40 overflow-hidden bg-charcoal py-2 text-white group">
      <div className="announcement-track whitespace-nowrap group-hover:[animation-play-state:paused]">
