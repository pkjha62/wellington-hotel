          ...
          {images.map((img, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/40 transition-all duration-500 flex items-center justify-center">
                <div className="opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-4 group-hover:translate-y-0 text-center p-3">
                  <p className="font-sans text-[10px] sm:text-xs tracking-[0.15em] uppercase text-white">{img.alt}</p>
                </div>
              </div>
            </motion.div>
          ))}
