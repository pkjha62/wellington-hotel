          ...
          <motion.div variants={columnItem}>
            ...
            <div className="flex gap-4">
              {[
                ...
                <a key={social.label} href={social.label === "Facebook" ? settings.facebookUrl : social.label === "Instagram" ? settings.instagramUrl : settings.twitterUrl} className="w-9 h-9 flex items-center justify-center border border-white/20 hover:border-gold hover:bg-gold/10 transition-all duration-300 group" aria-label={social.label}>
                  <svg className="w-4 h-4 fill-current text-white/60 group-hover:text-gold transition-colors duration-300" viewBox="0 0 24 24"><path d={social.path} /></svg>
                </a>
              ))}
            </div>
