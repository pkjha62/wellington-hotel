      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div ref={scrollRef} className="flex gap-4 sm:gap-6 overflow-x-auto lg:overflow-visible lg:grid lg:grid-cols-3 snap-x snap-mandatory" style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}>
          {experiences.map((exp, i) => (
            <motion.div
              key={exp.title}
              className="min-w-[80%] sm:min-w-[60%] lg:min-w-0 snap-start group cursor-pointer"
            ...
            >
              <div className="relative h-[300px] sm:h-[350px] md:h-[420px] overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-6 md:p-8">
                  ...
                  <span className="inline-flex items-center gap-2 mt-3 sm:mt-4 font-sans text-[10px] tracking-[0.2em] uppercase text-gold group-hover:text-gold-light transition-colors">
                    Discover
