...
export default function BookingPage() {
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-stone-50 px-4 py-10 sm:px-6 md:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="mb-10 grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
            <section className="rounded-[36px] bg-charcoal px-6 py-8 text-white shadow-xl sm:px-8 sm:py-10">
